...
func interrupt_notif():
	notif_text.set("custom_colors/font_color", Color(0.45098, 0, 0))
...
func heal_notif():
	notif_text.set("custom_colors/font_color", Color(0.168627, 0.698039, 0))
...
func damage_notif(is_crit):
	if is_crit == false: notif_text.set("custom_colors/font_color", Color(0.45098, 0, 0))
	elif is_crit == true: notif_text.set("custom_colors/font_color", Color(0.854902, 0.745098, 0))
